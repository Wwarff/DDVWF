...
{
 readonly TextBox host=new(),port=new(),database=new(),user=new(),password=new(),zoneVersion=new();readonly CheckBox enabled=new(){Content="Enable EQEmu SQL read integration"};
