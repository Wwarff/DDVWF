...
{
 readonly CommandHistory _history=new();readonly JsonWorkspaceStore _workspace;WorkspaceSettings _settings=new();ZoneSession? _session; SageClientZoneProvider? _client; string? _serverPassword;
