...
public static class WldAnimationReader
{
 ...
 public static SageTrackReference ReadTrackReference(WldFragment f,ReadOnlySpan<byte> source){var r=new R(source,f.PayloadOffset);var idx=checked((int)r.U32()-1);var flags=r.U32();var ms=(flags&1)!=0?r.I32():0;return new(idx,ms);}
