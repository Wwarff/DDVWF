...
public static class WldAnimationReader
{
 ...
 public static SageAnimatedVertices ReadAnimatedVertices(WldFragment f,ReadOnlySpan<byte> source){var r=new R(source,f.PayloadOffset);_=r.I32();var vc=r.U16();var fc=r.U16();var delay=r.U16();_=r.U16();var exp=r.U16();var scale=MathF.Pow(2f,-exp);var frames=new List<IReadOnlyList<Vector3>>(fc);for(var i=0;i<fc;i++){var frame=new List<Vector3>(vc);for(var j=0;j<vc;j++)frame.Add(new(r.I16()*scale,r.I16()*scale,r.I16()*scale));frames.Add(frame);}return new(delay,frames);}
