...
public static class EqEmuMySqlConnection
{
 ...
 public static EqEmuReadProvider CreateReadProvider(EqEmuMySqlSettings s,int zoneVersion=0,string? serverRoot=null)=>new(ct=>OpenAsync(s,ct),zoneVersion,serverRoot);
}
