...
public sealed record WorkspaceSettings
{
    ...
    public static Dictionary<string,string> ShortcutDefaults()=>new(StringComparer.OrdinalIgnoreCase){{"Select","Escape"},{"Move","NumPad1"},{"Rotate","NumPad2"},{"Scale","NumPad3"},{"Focus","NumPad5"},{"Undo","NumPad7"},{"Redo","NumPad8"},{"Duplicate","Ctrl+D"},{"Delete","Delete"},{"Stamp","Ctrl+S"}};
